...
--
-- Name: access; Type: TABLE; Schema: public; Owner: dirigente
--
...
ALTER TABLE public.access OWNER TO dirigente;

--
-- Name: access_idx_seq; Type: SEQUENCE; Schema: public; Owner: dirigente
--

CREATE SEQUENCE public.access_idx_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.access_idx_seq OWNER TO dirigente;

--
-- Name: access_idx_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dirigente
--

ALTER SEQUENCE public.access_idx_seq OWNED BY public.access.idx;
...
CREATE TABLE public.general (
    ...
    with_ministers boolean,
    qty_ministers integer,
    html boolean,
    testing boolean,
    active boolean,
    closed boolean
...
--
-- Name: access idx; Type: DEFAULT; Schema: public; Owner: dirigente
--

ALTER TABLE ONLY public.access ALTER COLUMN idx SET DEFAULT nextval('public.access_idx_seq'::regclass);
...
--
-- Name: access access_name_key; Type: CONSTRAINT; Schema: public; Owner: dirigente
--

ALTER TABLE ONLY public.access
    ADD CONSTRAINT access_name_key UNIQUE (name);


--
-- Name: access access_pkey; Type: CONSTRAINT; Schema: public; Owner: dirigente
--

ALTER TABLE ONLY public.access
    ADD CONSTRAINT access_pkey PRIMARY KEY (idx);
...
--
-- Name: general general_name_key; Type: CONSTRAINT; Schema: public; Owner: dirigente
--

ALTER TABLE ONLY public.general
    ADD CONSTRAINT general_name_key UNIQUE (name);
